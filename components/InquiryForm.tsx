  ...
  return (
    <Card className="p-6 rounded-2xl shadow-lg">
      <form onSubmit={handleSubmit} className="grid lg:grid-cols-2 gap-8">
            ...
            <Card className="p-3 bg-gray-50 rounded-lg">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Colombo 6, Sri Lanka</p>
                </div>
              </div>
            </Card>
          </div>
        ...
        {/* Right Side - Split Layout with Image */}
        <div className="flex h-full relative overflow-hidden rounded-2xl">
          ...
          <div className="bg-black rounded-r-2xl w-1/2 flex flex-col items-center justify-start pt-8 relative z-10 p-6">
            <div className="flex flex-col items-center space-y-3">
              <Image src={celesteLogoIcon} alt="Celeste Logo Icon" width={40} height={40} className="object-contain" />
              <Image src={celesteLogoWhite} alt="Celeste Logo" width={120} height={25} className="object-contain" />
            </div>
          </div>
