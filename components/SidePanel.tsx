    ...
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent side="left" className="w-[280px] sm:w-[320px]">
        ...
        <nav className="flex flex-col space-y-3 sm:space-y-4">
          ...
          <Link href="/help" className="flex items-center gap-2 text-sm sm:text-lg font-medium hover:text-blue-600"
            onClick={() => setIsOpen(false)}>
            <HelpCircleIcon className="h-4 w-4 sm:h-5 sm:w-5" />
            Help
          </Link>
          {user && (
            <>
              <Link href="/orders" className="flex items-center gap-2 text-sm sm:text-lg font-medium hover:text-blue-600"
                onClick={() => setIsOpen(false)}>
                <UserIcon className="h-4 w-4 sm:h-5 sm:w-5" />
                Orders
              </Link>
              <Link href="/cart" className="flex items-center gap-2 text-sm sm:text-lg font-medium hover:text-blue-600"
                onClick={() => setIsOpen(false)}>
              ...
              <Button
                ...
                className="flex items-center gap-2 text-sm sm:text-lg font-medium justify-start p-0 hover:text-blue-600"
              >
